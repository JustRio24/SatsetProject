...
<div class="space-y-8">
    ...
    <div class="bg-white p-6 rounded-3xl border border-slate-100 flex flex-wrap gap-4 items-center">
        <form action="{{ route('direksi.financial') }}" method="GET" class="flex flex-wrap gap-4 items-center w-full">
            ...
            <button type="button" class="px-6 py-2 bg-amber-400 text-slate-900 rounded-xl font-bold text-sm ml-auto flex items-center gap-2">
    ...
    <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-slate-50 overflow-hidden">
        <div class="p-10 border-b border-slate-50 bg-slate-900 text-white flex justify-between items-center">
            <div>
